...
func (m *MockAuthService) LoginWithGoogle(dto *models.GoogleLoginRequestDTO) (*models.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockAuthService) RefreshTokens(refreshToken string) (*models.Auth, error) {
	m.ctrl.T.Helper()
